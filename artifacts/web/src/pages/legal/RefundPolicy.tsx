export default function RefundPolicy() {
  return (
    <div className="container mx-auto px-4 md:px-8 max-w-screen-md py-20 prose dark:prose-invert">
      ...
      <p>Thank you for choosing Nexus Wave Technologies. We stand behind the engineering quality of our products, including Nexus Plus, Geeta Nexus, and our Universal Gateway services. However, we understand that situations arise where a refund may be requested.</p>
      ...
      <p>For enterprise clients utilizing the Universal Gateway under custom service level agreements (SLAs), refund and credit policies are governed by the specific terms outlined in your contract.</p>
